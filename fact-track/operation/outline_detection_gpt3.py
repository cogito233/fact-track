...
def generate_outline_withInjection(logSaver, premise = None, outline = None, max_depth = 2, injection = None, keep_both = True, bandwidth = 3):
    ...
    # contradictDetector = ContradictDetector_StatusPersistence(model_name_decompose = "gpt-3.5-turbo",
...
if __name__ == "__main__":
    ...
    # wrapper_detectionFromGeneration("1010_pure_simple", max_depth = 3, output_name="1010_pure_simple_detect_gpt3")
    for i in range(6, 7):
        wrapper_detectionFromGeneration(f"{1010+i}_pure_simple", max_depth = 3, output_name=f"{1010+i}_pure_simple_detect_gpt4")